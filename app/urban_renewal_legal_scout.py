...
USAGE_RIGHTS_FOOTER_HTML = (
    'Urban Renewal Intelligence Dashboard · Public-data exploration tool for Israeli urban renewal projects.'
)
HEBREW_LABELS = {
...
.soft-card { background: #ffffff; border: 1px solid #dbe4ee; border-radius: 8px; padding: 1rem 1.1rem; margin: 0.45rem 0; color: #0f172a !important; }
.warning-card { background: #fff7ed; border: 1px solid #fed7aa; border-radius: 8px; padding: 1rem 1.1rem; margin: 0.45rem 0; color: #7c2d12 !important; }
.success-card { background: #ecfdf5; border: 1px solid #bbf7d0; border-radius: 8px; padding: 1rem 1.1rem; margin: 0.45rem 0; color: #14532d !important; }
...
.rights-card a, .rights-footer a { color: #0f4c81 !important; font-weight: 700; }
.rights-footer {
    margin-top: 1.5rem;
    padding: 0.8rem 1rem;
...
.upload-callout * { color: #0f172a !important; opacity: 1 !important; }
div[data-testid="stAlert"] * {
    opacity: 1 !important;
}
div[data-testid="stDataFrame"] { direction: rtl; }
a { color: #0f4c81; font-weight: 650; }
</style>
